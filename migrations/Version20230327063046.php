 ...
 */
<<<<<<<< HEAD:migrations/Version20230327063046.php
final class Version20230327063046 extends AbstractMigration
========
final class Version20230327063152 extends AbstractMigration
>>>>>>>> 7c9281a6013cbccd540f3665d8c7cabdd1be7550:migrations/Version20230327063152.php
{
...
========
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, points INT NOT NULL, levels INT NOT NULL, signup_date DATE NOT NULL, last_signin_date_time DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
>>>>>>>> 7c9281a6013cbccd540f3665d8c7cabdd1be7550:migrations/Version20230327063152.php
